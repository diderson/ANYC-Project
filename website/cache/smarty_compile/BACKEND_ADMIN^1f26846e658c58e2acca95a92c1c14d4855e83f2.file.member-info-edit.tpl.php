<?php /* Smarty version Smarty-3.1.19, created on 2015-04-22 21:22:16
         compiled from ".\templates-admin\content\member-info-edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:246935537f2f7542560-41603053%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1f26846e658c58e2acca95a92c1c14d4855e83f2' => 
    array (
      0 => '.\\templates-admin\\content\\member-info-edit.tpl',
      1 => 1429730439,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '246935537f2f7542560-41603053',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5537f2f77e6193_95856816',
  'variables' => 
  array (
    'editData' => 0,
...
<?php if ($_valid && !is_callable('content_5537f2f77e6193_95856816')) {function content_5537f2f77e6193_95856816($_smarty_tpl) {?><a href="profile-edit" title="click to edit"><h3>Fullname : <?php echo htmlspecialchars($_SESSION['BACKEND_ADMIN']['ADMIN_FIRSTNAME'], ENT_QUOTES, 'UTF-8', true);?>
...
<div class="row">
	<div class="col-lg-4">
		...
		<select name="employment_institut[]" class="form-control">
			...
			<option value="SAP" <?php if ($_smarty_tpl->tpl_vars['editData']->value[0]['employment'][$_smarty_tpl->getVariable('smarty')->value['section']['job']['index']]['employment_institut']=='SAP') {?> selected="selected"<?php }?>>SAP</option>
	...
	<div class="col-lg-4">
		...
		<select name="employment_position[]" class="form-control">
			...
			<option value="Director" <?php if ($_smarty_tpl->tpl_vars['editData']->value[0]['employment'][$_smarty_tpl->getVariable('smarty')->value['section']['job']['index']]['employment_position']=='Director') {?> selected="selected"<?php }?>>Director</option>
			<option value="Coordinator" <?php if ($_smarty_tpl->tpl_vars['editData']->value[0]['employment'][$_smarty_tpl->getVariable('smarty')->value['section']['job']['index']]['employment_position']=='Coordinator') {?> selected="selected"<?php }?>>Coordinator</option>
			<option value="PA" <?php if ($_smarty_tpl->tpl_vars['editData']->value[0]['employment'][$_smarty_tpl->getVariable('smarty')->value['section']['job']['index']]['employment_position']=='PA') {?> selected="selected"<?php }?>>PA</option>
...
<?php $_tmp5=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['editData']->value[0]['ancmember_province']==$_tmp5) {?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['provinceData']->value[$_smarty_tpl->getVariable('smarty')->value['section']['a']['index']]['province_name'];?>
	...
	<div class="col-lg-3">
		<label>Region</label>
		<input class="form-control" placeholder="Region" id="ancmember_region" name="ancmember_region" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['editData']->value[0]['ancmember_region'], ENT_QUOTES, 'UTF-8', true);?>
">
	</div>
