                                      ...
                                      {section name=a loop=$list}
                                       <tr id="tr{$list[a].id|escape:"html"}" class="{cycle values="odd,even"}">
                                          <td>{$list[a].id|escape:"html"}</td>
                                            <td>{$list[a].service_designation}</td>
                                            <td class="center" id="tdstatus{$list[a].id|escape:"html"}">
                                           {include file="templates-admin/block/list-entrystatus.tpl" fieldName="service_status" currentValue=$list[a].service_status listData=$list[a]}
                                           </td>
