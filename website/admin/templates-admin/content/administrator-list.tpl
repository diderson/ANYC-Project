                                    ...
                                    <tbody>
                                      {section name=a loop=$list}
                  									    <tr id="tr{$list[a].id|escape:"html"}" class="{cycle values="odd,even"}">						
                  												...
                  												<td>{$list[a].email_address|escape:"html"}</td>			
                  												<td>{$list[a].first_name}</td>			
                  												<td>{$list[a].last_name}</td>            
                  												<td>{$list[a].administratortype_name|escape:"html"}</td>						
                  												<td class="center" id="tdstatus{$list[a].id|escape:"html"}">
                  													{include file="templates-admin/block/list-entrystatus.tpl" fieldName="administrator_status" currentValue=$list[a].administrator_status listData=$list[a]}
                  												</td>
                  												<td class="t-nowrap">{$list[a].cdate|escape:"html"}</td>
                  												<td class="t-nowrap">{$list[a].ldate|escape:"html"}</td>
