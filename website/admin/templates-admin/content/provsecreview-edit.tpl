          ...
          <div class="panel-body">
              <div class="table-responsive">
                  <table class="table table-striped">
                      ...
                      <tbody>
                        {section name=y loop=$prosecGovernanceData}
                          <tr>
                              <td><input type="hidden" name="provsec_preview_size[]">{$prosecGovernanceData[y].id_provsec_preview}</td>
                              <td>{$prosecGovernanceData[y].provsec_preview_libele}</td>
                              <td class="col-lg-2">
                                {assign var="provsec_preview" value=$editData[0].provsec_preview}
                                {assign var="constreviewid" value=$prosecGovernanceData[y].id_provsec_preview}
                                {capture assign=preview_id}preview_{$constreviewid}{/capture}
                                <select name="preview_{$prosecGovernanceData[y].id_provsec_preview}" class="form-control col-lg-2">
                                  {section name=rate start=1 loop=6}
                                    <option value="{$smarty.section.rate.index}" {if $provsec_preview.$preview_id eq {$smarty.section.rate.index}} selected="selected"{/if}>{$smarty.section.rate.index}</option>
                                  {/section}
                                </select>
                              </td> 
                          </tr>
                      ...
                      <tbody>
                          ...
                          <tr>
                            {section name=k loop=$OverPerformanceData}
                              <td class="">
                                {assign var="provsec_ovpefrating" value=$editData[0].provsec_ovpefrating}
                                ...
                                <select name="ovpefrating_{$OverPerformanceData[k].id_ovpefrating}" class="form-control col-lg-2">
                                  {section name=rate start=1 loop=6}
                                    <option value="{$smarty.section.rate.index}" {if $provsec_ovpefrating.$ovpefrating_id eq {$smarty.section.rate.index}} selected="selected"{/if}>{$smarty.section.rate.index}</option>
                                  {/section}
                                </select>
                              </td> 
                            {/section}
...
{if $editData[0].id_provsec_preview_ass neq ''}
